...
# elif 15 < number <= 20:
#     result_1 = input("Wrong value")
# else:
#     result_1 = "Wrong number range, please enter a number between 1 and 20 and re-run the code"
# print(result_1)
...
# number_1 = int(input("Please enter the first number between 1 and 10: "))
...
# if len(first_name) < 6 and len(last_name) < 6:
#     result_3 = first_name + " " + last_name
# else:
#     result_3 = "Parameters are not met"
# print(result_3)
